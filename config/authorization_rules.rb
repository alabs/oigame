...
authorization do
  role :anonymous do
    has_permission_on [:campaigns], :to => [:index, :widget ,:widget_iframe, :message_sign, :petition_sign, :signed, :fax_send,
    ...
    has_permission_on [:pages], :to => [:index, :help, :tutorial, :privacy_policy, :contact, :contact_received, :about, :activity]
