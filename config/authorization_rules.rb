...
authorization do
  role :anonymous do
    has_permission_on [:campaigns], :to => [:index, :widget ,:widget_iframe, :sign, :signed, :validate, :integrate, :validated, :feed, :archived, :list, :search, :add_credit, :credit_added, :credit_denied]
